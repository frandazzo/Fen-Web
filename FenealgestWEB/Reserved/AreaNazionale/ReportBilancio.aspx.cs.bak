...
{
    public partial class ReportBilancio : BaseReservedArea
    {
        ...
        protected override string SitePagePath
        {
            get
            {
                return "Home -> Area riservata -> Nazionale -> Report bilancio regionale";
            }
        }
        ...
        {
            get { return "Report bilancio regionale"; }
        }
