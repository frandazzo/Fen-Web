<%@ Page Title="Reportistica rendiconti provinciali" Language="C#" MasterPageFile="~/FenealgestwebNew.Master" AutoEventWireup="true" CodeBehind="ReportBilancioProvinciale.aspx.cs" Inherits="FenealgestWEB.Reserved.AreaNazionale.ReportBilancioProvinciale" %>
...
<div class="content">
    <div class="login">
				<h2>Reportistica rendiconti provinciali</h2>
				<br/>
				<br/>
       ...
       <asp:DropDownList ID="cboConto" runat="server" AutoPostBack="True" Font-Size="12px" Width="200px">
            ...
            <asp:ListItem Value="S.OI.3.%">- - Contributo struttura regionale</asp:ListItem>
            <asp:ListItem Value="S.OI.4.%">- - Tesseramento</asp:ListItem>
            <asp:ListItem Value="S.OI.5.%">- - Contributi straordinari</asp:ListItem>
            <asp:ListItem Value="S.OI.6.%">- - Spese generali</asp:ListItem>
            <asp:ListItem Value="S.OI.7.%">- - Spese beni durevoli</asp:ListItem>
            ...
            <asp:ListItem Value="E.OI.1.%">- - Contributi territoriali</asp:ListItem>
            <asp:ListItem Value="E.OI.2.%">- - Tesseramento diretto</asp:ListItem>
            <asp:ListItem Value="E.Oi.3.%">- - Contributi</asp:ListItem>
            <asp:ListItem Value="E.OI.4.%">- - Entrate varie</asp:ListItem>
            <asp:ListItem Value="E.OI.5.%">- - Entrate per rimborso attività RLST</asp:ListItem>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT NomeRegione, NomeProvincia, Anno, DescrizioneNodo, ImportoBilancio FROM viewrendiconto WHERE (IdNodo LIKE ?) AND (Anno = ?) AND (NomeProvincia not like '') AND (ContoRLST = 'FENEAL')">
            <SelectParameters>
     ...
     <div class="column">
			    ...
			    <ul>
				    <li>
					    ...
					    La pagina corrente permette di visualizzare un report per i rendiconti a livello provinciale.<br />
              ...
              sulle riporta colonne la voce o le sottovoci del conto prescelto<br />
