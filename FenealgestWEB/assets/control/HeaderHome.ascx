<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HeaderHome.ascx.cs" Inherits="FenealgestWEB.assets.control.HeaderHome" %>
...
<div class="border_bottom">
    <div id="header">
	    <div class="left">			
		    <a href="/ReservedAreaHomePage.aspx">
		    ...
		    <div class="bg">
			    <div class="menu">	  
				    ...
				    <ul>
					    ...
					    <li>
						    <a href="http://www.fenealuil.it/">
							    Vai al sito della Feneal <asp:Image ID="Image4" runat="server" ImageUrl="~/images/down_arrow.png" />
						    </a>
					    </li>
					    <% } else { %>
					    <li>
						    <asp:LinkButton ID="LinkButton3" runat="server" CssClass="invia" 
                                onclick="LinkButton1_Click">
						        Esci <asp:Image ID="Image5" runat="server" ImageUrl="~/images/down_arrow.png" /> 
						    </asp:LinkButton>
					    </li>
					     <% } %>
				    </ul>
