...
{
    public partial class ReportDatiEconomiciControl : DevExpress.XtraEditors.XtraUserControl, IPrintableAndSearchable
    {
        public ReportDatiEconomiciControl(TestSharetoIntegration mainForm)
        {
            InitializeComponent();


            mainForm.lblFunction.Text = "Report dati economici";
        ...
        private void Link_CreateMarginalHeaderArea(object sender, CreateAreaEventArgs e)
        {
            ...
            brick1 = e.Graph.DrawString("               Report dati economici", Color.Navy, new RectangleF(0, 0, 500, 40), DevExpress.XtraPrinting.BorderSide.None);
        ...
        private void simpleButton1_Click_2(object sender, EventArgs e)
        {
            ...
            AdministrativeRecord[] list = null;

            try
            {
                list = agent.FindAdministrativeData(Convert.ToInt32(comboBoxEdit1.Text));
