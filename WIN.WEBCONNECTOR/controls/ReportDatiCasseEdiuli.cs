...
{
    public partial class ReportDatiCasseEdiuli : DevExpress.XtraEditors.XtraUserControl, IPrintableAndSearchable
    {
        public ReportDatiCasseEdiuli(TestSharetoIntegration mainForm)
        {
            InitializeComponent();


            mainForm.lblFunction.Text = "Report dati casse edili";
        ...
        private void Link_CreateMarginalHeaderArea(object sender, CreateAreaEventArgs e)
        {
            ...
            brick1 = e.Graph.DrawString("               Report dati casse edili", Color.Navy, new RectangleF(0, 0, 500, 40), DevExpress.XtraPrinting.BorderSide.None);
        ...
        private void simpleButton1_Click_1(object sender, EventArgs e)
        {
            ...
            DatiCassaEdile[] list = agent.FindDatiCasseEdili(Convert.ToInt32(comboBoxEdit1.Text));
