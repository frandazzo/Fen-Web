...
Public Class MapperCongressoTerritoriale
...
#Region "Istruzioni Sql"
    ...
    Protected Overrides Function FindAllStatement() As String
        Return "Select * from sharetop_congressoterritoriale"
    End Function

    Protected Overrides Function FindByKeyStatement() As String
        Return "Select * from sharetop_congressoterritoriale where Id = @Id"
    End Function

    Protected Overrides Function InsertStatement() As String
        Return "Insert into sharetop_congressoterritoriale (Id_Regione, Id_Provincia, Anno, Id_Survey, SegretarioGenerale," _
                & "SegretarioOrganizzativo, " _
                & "MembriSegretaria,Tesoriere,ConsiglioTerritoriale,ConsiglioTerritorialeSupplente," _
                & "AssembleaTerritoriale,AssembleaTerritorialeSupplente,RevisoriDeiConti) " _
                & "values (@idr, @idp, @ann, @ids, @gen,@org, @seg, @tes, @conter, @conters, @asster, @assters, @rev)"
    End Function
    ...
    Protected Overrides Function DeleteStatement() As String
        Return "Delete from sharetop_congressoterritoriale where ID = @Id"
    End Function
...
#Region "Metodi per la ricerca dell'oggetto secondo l'id proposto"
    ...
    Public Overrides Function FindObjectById(ByVal Id As Integer) As AbstractPersistenceObject
        ...
        Return DirectCast(MyBase.FindByKey(New Key(Id)), CongressoTerritoriale)
    ...
    Protected Overloads Overrides Function DoLoad(ByVal Key As Key, ByVal rs As System.Collections.Hashtable) As AbstractPersistenceObject
        Try
            ...
            Dim exp As New CongressoTerritoriale
            exp.Key = Key
        ...
        Catch ex As Exception
            Throw New Exception("Impossibile caricare l'oggetto CongressoTerritoriale con Id = " & Key.LongValue & ". " & vbCrLf & ex.Message)
        End Try
    End Function
...
#End Region
    ...
    Protected Overrides Sub LoadInsertCommandParameters(ByVal Item As AbstractPersistenceObject, ByVal Cmd As System.Data.IDbCommand)
        Try
            Dim lavoratore As CongressoTerritoriale = DirectCast(Item, CongressoTerritoriale)
        ...
        Catch ex As Exception
            Throw New Exception("Impossibile caricare il comando di inserimento dell'oggetto CongressoTerritoriale." & vbCrLf & ex.Message)
        End Try
    End Sub
