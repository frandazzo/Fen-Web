...
#Region "Istruzioni Sql"
    ...
    Protected Overrides Function InsertStatement() As String
        Return "Insert into lavoratori (CodiceFiscale, Nome, Cognome, NomeCompleto, " _
                ...
                & "@idpr, @nmpr, @idcr, @nmcr, @ind, @cap, @tel, @ulm, @ulp)"
    End Function
    ...
    Protected Overrides Function UpdateStatement() As String
        Return "UPDATE lavoratori SET " _
                ...
                & "Id_Comune = @idc, " _
                & "NomeComune = @nmc, " _
                & "Id_Provincia_Residenza = @idpr, " _
                & "NomeProvinciaResidenza = @nmpr, " _
                & "Id_Comune_Residenza = @idcr, " _
                & "NomeComuneResidenza = @nmcr, " _
                & "Indirizzo = @ind, " _
                & "Cap = @cap, " _
                & "Telefono = @tel, " _
