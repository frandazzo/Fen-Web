...
namespace WIN.FENGEST_NAZIONALE.DOMAIN.ValidationSubsystem
{
    public class WorkerFactory
    {
        ...
        public static Worker CrateWorker(WorkerDTO workerPrototype, GeoLocationFacade geoFacade, Export parent)
        {
            ...
            w.ModificatoDa = parent.Province.Descrizione;
            ...
            if (workerPrototype.Documents != null)
            {
                foreach (DocumentDTO item in workerPrototype.Documents)
                {
                    w.Documents.Add(DocumentFactory.CreateDocument(item, w, parent, geoFacade));
                }
            }
