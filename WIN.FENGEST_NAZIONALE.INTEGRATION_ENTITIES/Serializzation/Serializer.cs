...
namespace WIN.FENGEST_NAZIONALE.INTEGRATION_ENTITIES.Serializzation
{
    public static class Serializer<T> where T : class // Specify that T must be a class.
    {
        ...
        public static T Load(string path, SerialFormat serializedFormat)
        {
        ...
        public static T Load(string fileName, IsolatedStorageFile isolatedStorageDirectory, SerialFormat serializedFormat)
        {
            T serializableObject = null;
        ...
        public static void Save(T serializableObject, string path, SerialFormat serializedFormat)
        {
            switch (serializedFormat)
            {
                case SerialFormat.Binary:
        ...
        /// <param name="isolatedStorageDirectory">Isolated storage area directory containing the XML file to save the object to.</param>
        /// <param name="serializedFormat">XML serialized format used to save the object.</param>        
        public static void Save(T serializableObject, string fileName, IsolatedStorageFile isolatedStorageDirectory, SerialFormat serializedFormat)
        {
            switch (serializedFormat)
            {
                case SerialFormat.Binary:
